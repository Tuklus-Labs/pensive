...
- **PoC:**
  ...
  6. Observe an `at projects//tmp/glasswing-secret.txt#L1-1` furniture line. Repeat the ref as `claude-home//home/aegis/.keys` to make the daemon read the key file (contents still not returned unless they match `newText`).
