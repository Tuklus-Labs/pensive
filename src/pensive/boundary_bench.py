...
# The print-based CLI report layer (print_boundary_benchmark,
# print_boundary_candidate_mining, main) lives in boundary_bench_cli so
# importing the scoring functions does not pull in presentation code
# (REFACTOR-6). Run it via bench_boundary.py at the repo root or
# `python -m pensive.boundary_bench_cli`.
